...
from core.guiServer import check_chivalry_window
...
class PlayersWindow(QDialog):
    def __init__(self, parent=None):
        ...
        try:
            if sys.platform == 'win32':
                self._cb_event_filter = WinClipboardEventFilter(self.on_clipboard_changed)
